@{
	...
	'Add-PSFRunspaceWorker.Error.UntrustedFunctionCode' = 'Failed to load function {0}: The provided function code is not trusted (in Constrained language Mode) and cannot be imported. Ensure the code building the scriptblock is trusted to create a non-constrained scriptblock.'
	'Add-PSFRunspaceWorker.Error.UntrustedTextFunction' = 'Failed to load function {0}: String-based code is not trusted in a secured console. Provide its code as a scriptblock, rather than a string to enable code trust verification.'
	'Add-PSFRunspaceWorker.Error.VersionTooLow' = 'Invalid Runspace Worker Version specified! Version specified: {0} | Minimum Version required for the selected parameters: {1}'
	...
	'Invoke-PSFRunspace.Error.ModuleImport' = 'Failed to include module: "{0}"'
	'Invoke-PSFRunspace.Error.UntrustedFunctionCode' = 'Failed to import function "{0}". Scriptblock is not in FullLanguage mode and thus not trusted!'
	'Invoke-PSFRunspace.Error.UntrustedTextFunction' = 'Failed to import function "{0}". Providing function-code as text is not supported in a hardened PowerShell process. Provide the function-code instead as a scriptblock.'
	'New-PSFRunspaceWorkflow.Error.ExistsAlready' = 'Failed to create workflow {0}: It already exists! Use "-Force" to overwrite the existing Runspace Workflow, interrupting all currently ongoing processing.'
	...
	'New-PSFSupportPackage.Error.PathNotFound' = 'Path not found: "$Path". Ensure the path exists or use -Force to create it.'
	'New-PSFSupportPackage.Export.Failed' = 'Failed to export dump to file!'
	'New-PSFSupportPackage.Extension.Collecting' = 'Collecting Extension Debugging Data: {0}'
	'New-PSFSupportPackage.Extension.Collecting.Failed' = 'Failed to collect Extension Debugging Data: {0}'
...
This will make it easier for us to troubleshoot and you won''t be sending us the keys to your castle.'
	...
	'New-PSFThrottle.Error.InvalidLimit' = 'Invalid throttle limit: {0} / {1}'
	'Read-PsfConfigEnvironment.BadData' = 'Cannot import setting from registry: {0} - Error parsing: {1}'
	'Read-PSFRunspaceQueue.Error.Continual.TooManyWorkflows' = 'Error resolving queue to read from in continuous mode: {0}. Multiple workflows found, while continuous read only supports a single workflow. Workflows found: {1}'
	...
	'Resolve-PsfRunspaceWorkflow.Error.NotFound' = 'No Runspace Workflow found under the specified name(s): {0}'
	'Set-PSFLoggingProvider.Error.ConfigNoName' = 'Invalid logging configuration: No provider name ("Name") specified! | {0}'
	...
	'Wait-PSFRunspaceWorkflow.Error.Timeout' = 'Timeout ({0:HH:mm:ss}) reached waiting for Runspace Workflow "{1}" to complete'
}