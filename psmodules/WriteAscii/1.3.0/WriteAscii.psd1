...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '
    * Fix cross-platform support by using "Sort-Object" instead of "Sort".'
...
HelpInfoURI = 'https://www.powershelladmin.com/wiki/Ascii_art_characters_powershell_script.php'
